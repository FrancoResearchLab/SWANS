...
# Sample Metadata
meta <- read.csv(file.path(root_dir, 'samples.sample_list'), sep = '\t', header = TRUE)
meta <- meta[, 1:2]
...
cluster_annotation <- paste0(root_dir, final_info$`CLUSTER_ANNOTATION_FILE`)
file_user_gene_file <- paste0(root_dir, final_info$`FINAL_USER_GENE_FILE`) #need to double check if this causes an error
...
# Sig PC 
sig_pc_file <- paste0(data_dir, project, '/analysis/tables/', project, '_', normalization, '_pca_sigPC.txt')
...
#-------------------------------------------------------------------------------
final_markers_file <- paste0(data_dir, project, '/analysis/final_analysis/tables/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_final_markers_total.txt') 
...
csv_folder <- paste0(data_dir, project, '/analysis/final_analysis/tables/csv_files/')
...
# adjusted p.value
final_pathways_file.adjP <- paste0(data_dir, project, '/analysis/final_analysis/pathway_analysis/tables/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_final_filtered_results_combined_pathways_p_val_adj.csv')
final_pathways_adjP <- ''
...
# avglog2FC
final_pathways_file.log <- paste0(data_dir, project, '/analysis/final_analysis/pathway_analysis/tables/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_final_filtered_results_combined_pathways_avg_log2fc.csv')
final_pathways_log <- ''
...
#-------------------------------------------------------------------------------
counts_sample_file <- paste0(data_dir, project, '/analysis/final_analysis/tables/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_final_cluster_counts_proportions_sample.txt')
counts_sample <- read.table(counts_sample_file, header=TRUE, sep='\t')

counts_experiment_file <- paste0(data_dir, project, '/analysis/final_analysis/tables/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_final_cluster_counts_proportions_experiment.txt')
counts_experiment <- read.table(counts_experiment_file, header=TRUE, sep='\t')
#-------------------------------------------------------------------------------

# Cell Cycling Phase + Frequency
#-------------------------------------------------------------------------------
phase_table_experiment_file <- paste0(data_dir, project, '/analysis/final_analysis/tables/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_phase_experiment.txt')
phase_table_experiment <- read.table(phase_table_experiment_file, header=TRUE, sep='\t')

phase_table_sample_file <- paste0(data_dir, project, '/analysis/final_analysis/tables/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_phase_sample.txt')
phase_table_sample <- read.table(phase_table_sample_file, header=TRUE, sep='\t')
#-------------------------------------------------------------------------------

# Z-scores
#-------------------------------------------------------------------------------
z_scores_file_celltypes <- paste(data_dir, project, '/analysis/final_analysis/tables/', project, '_z_scores.', normalization, '.', integration, '_snn_res.', resolution, '_celltypes.txt', sep='')
...
z_scores_file_celltypes_experiment <- paste(data_dir, project, '/analysis/final_analysis/tables/', project, '_z_scores.', normalization, '.', integration, '_snn_res.', resolution, '_celltypes_experiment.txt', sep='')
...
z_scores_file_celltypes_experiment_samples <- paste(data_dir, project, '/analysis/final_analysis/tables/', project, '_z_scores.', normalization, '.', integration, '_snn_res.', resolution, '_celltypes_experiment_sample.txt', sep='')
...
# dynamic z-scores
z_folder <- paste0(data_dir, project, '/analysis/final_analysis/tables/z_score_files/')
...
variable_genes_file <- paste0(data_dir, project, '/analysis/tables/', project, '_', normalization, '_variable_genes.txt')
...
# IMAGES
#-------------------------------------------------------------------------------
umap <- paste0(data_dir, project, '/analysis/final_analysis/figures/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_umap.png')
umap_phase <- paste0(data_dir, project, '/analysis/final_analysis/figures/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_umap_phase.png')
umap_phase_experiment <- paste0(data_dir, project, '/analysis/final_analysis/figures/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_umap_phase_experiment.png')
umap_phase_sample <- paste0(data_dir, project, '/analysis/final_analysis/figures/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_umap_phase_sample.png')
phase_experiment <- paste0(data_dir, project, '/analysis/final_analysis/figures/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_geom_point_phase_sample.png')
phase_sample <- paste0(data_dir, project, '/analysis/final_analysis/figures/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_geom_point_phase_experiment.png')
umap_experiment <- paste0(data_dir, project, '/analysis/final_analysis/figures/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_umap_experiment.png')
umap_sample <- paste0(data_dir, project, '/analysis/final_analysis/figures/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_umap_sample.png')
proportions_sample <- paste0(data_dir, project, '/analysis/final_analysis/figures/', project, '_barplot_proportions_sample_', normalization, '.', integration, '_snn_res.', resolution, '.png')
proportions_experiment <- paste0(data_dir, project, '/analysis/final_analysis/figures/', project, '_barplot_proportions_experiment_', normalization, '.', integration, '_snn_res.', resolution, '.png')
heatmap_plot <- paste0(data_dir, project, '/analysis/final_analysis/figures/', project, '_', normalization, '_variable_genes_heatmap.png')
trajectory_clusters_file <- paste0(data_dir, project, '/analysis/final_analysis/trajectory_analysis/figures/', project, '_monocle3_clusters.png')
#-------------------------------------------------------------------------------
```
