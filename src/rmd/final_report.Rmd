...
file_user_gene_file <- paste0('../../', final_info$`FINAL_USER_GENE_FILE`) #need to double check if this causes an error
...
#-------------------------------------------------------------------------------
phase_table_experiment_file <- paste0('../../data/endpoints/', project, '/analysis/final_analysis/tables/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_phase_experiment.txt')
phase_table_experiment <- read.table(phase_table_experiment_file, header=TRUE, sep='\t')

phase_table_sample_file <- paste0('../../data/endpoints/', project, '/analysis/final_analysis/tables/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_phase_sample.txt')
...
umap_phase_experiment <- paste0('../../data/endpoints/', project, '/analysis/final_analysis/figures/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_umap_phase_experiment.png')
umap_phase_sample <- paste0('../../data/endpoints/', project, '/analysis/final_analysis/figures/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_umap_phase_sample.png')
phase_experiment <- paste0('../../data/endpoints/', project, '/analysis/final_analysis/figures/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_geom_point_phase_sample.png')
phase_sample <- paste0('../../data/endpoints/', project, '/analysis/final_analysis/figures/', project, '_', normalization, '.', integration, '_snn_res.', resolution, '_geom_point_phase_experiment.png')
