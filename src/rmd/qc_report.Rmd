...
if (run_soupX == TRUE) 
{
  for (sample in samples) 
  {
    ...
    # Path to figure
    soupX_imgs[[sample]] = file.path(sample_soupX_dir, project, '_', sample, '_contam_plot.png')
  }
}
...
prefilt_vln = file.path(analysis_dir, project, '_', 'qc_1_vln.png')
prefilt_scat1 = file.path(analysis_dir, project, '_', 'qc_1_scatter1.png')
prefilt_scat2 = file.path(analysis_dir, project, '_', 'qc_1_scatter2.png')

# Post-filt images (qc_2)
postfilt_vln = file.path(analysis_dir, project, '_', 'qc_2_vln.png')
postfilt_scat1 = file.path(analysis_dir, project, '_', 'qc_2_scatter1.png')
postfilt_scat2 = file.path(analysis_dir, project, '_', 'qc_2_scatter2.png')
